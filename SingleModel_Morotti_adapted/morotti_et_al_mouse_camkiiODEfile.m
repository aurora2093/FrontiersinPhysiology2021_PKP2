...
CaMKIIactDyad = p(1); LCCtotDyad = p(2); RyRtot = p(3); PP1_dyad = p(4); PP2A_dyad = p(5);OA = p(6); PLBtot = p(7);
CaMKIIactSL = p(8); LCCtotSL = p(9); PP1_SL = p(10); PP1_PLB_avail = p(11);
% yCell=mat2cell(y,ones(size(y,1),1),ones(size(y,2),1));
% yCell=num2cell(y);
% [LCC_PKAp,LCC_CKdyadp,RyR2809p,RyR2815p,PLBT17p,LCC_CKslp] = yCell{:};
LCC_PKAp = y(1); LCC_CKdyadp = y(2); RyR2809p = y(3); RyR2815p = y(4); PLBT17p = y(5);LCC_CKslp = y(6);
% Default PKA level
PKAc = 95.6*.54;
