...
K=params(1); Mg=params(2);CaMtot=params(3); Btot=params(4);CaMKIItot=params(5);CaNtot=params(6);PP1tot=params(7);
Ca=params(8);cyclelength=params(9);compartment=params(10);
...
CaM=y(1); Ca2CaM=y(2); Ca4CaM=y(3); CaMB=y(4); Ca2CaMB =y(5); Ca4CaMB=y(6);                 % variables 1-6
Pb2=y(7); Pb=y(8); Pt=y(9); Pt2=y(10); Pa=y(11);                                    % variables 7-11
Ca4CaN=y(12); CaMCa4CaN=y(13); Ca2CaMCa4CaN=y(14); Ca4CaMCa4CaN=y(15);
% Ca/CaM parameters
if Mg <= 1
