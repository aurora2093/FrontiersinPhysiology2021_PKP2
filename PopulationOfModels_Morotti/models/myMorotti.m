function output = myMorotti(t,y,p,cond,PKP2flag,experimflag,CabFac)
...
cycleLength = p(1);recoveryTime= p(2);variablePar= p(3);CaMtotDyad= p(4);BtotDyad= p(5);
CaMKIItotDyad= p(6);CaNtotDyad= p(7);PP1totDyad= p(8);
CaMtotSL= p(9);BtotSL= p(10);CaMKIItotSL= p(11);CaNtotSL= p(12);PP1totSL= p(13);
CaMtotCyt= p(14);BtotCyt= p(15);CaMKIItotCyt= p(16);CaNtotCyt= p(17);PP1totCyt= p(18);
LCCtotDyad= p(19);RyRtot= p(20);PP1_dyad= p(21);PP2A_dyad= p(22);OA= p(23);PLBtot= p(24);LCCtotSL= p(25);
PP1_SL= p(26);Ligtot= p(27);LCCtotBA= p(28);RyRtotBA= p(29);PLBtotBA= p(30);TnItotBA= p(31);
IKstotBA= p(32);ICFTRtotBA= p(33);PP1_PLBtot= p(34);IKurtotBA= p(35);PLMtotBA= p(36); CKIIOE= p(37);
...
dydt_ecc = myMorotti_ecc(t,y_ecc,pECC,cond,PKP2flag,experimflag,CabFac);
...
output = [dydt_ecc; dydt_camDyad; dydt_camSL; dydt_camCyt; dydt_CaMKIIDyad; dydt_BAR];